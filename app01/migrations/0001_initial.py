# Generated by Django 3.0.3 on 2020-04-08 09:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(max_length=99, verbose_name='博客标题')),
                ('site_name', models.CharField(max_length=99, verbose_name='站点名')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
                ...
                ('blogs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Blog', verbose_name='所属博客')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Tag')),
            ],
            options={
